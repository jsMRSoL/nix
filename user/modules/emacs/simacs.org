...
#+begin_src emacs-lisp
  ...
  (use-package org
    ...
    (set-face-attribute 'org-level-2 nil :height 1.3 :weight 'regular)
    (set-face-attribute 'org-level-1 nil :height 1.4 :weight 'regular)
    (set-face-attribute 'org-document-title nil :height 1.8 :bold t :underline nil))
