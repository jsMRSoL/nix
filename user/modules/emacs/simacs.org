  ...
  #+begin_src emacs-lisp
    ...
    (setq org-capture-templates
    	...
    	("jd" "Daily Journal Entry"
    	 entry
    	 (file+olp "~/Documents/org/journal.org" "Journal" "Daily")
    	 ,(concat "* Journal Entry %<%Y-%m-%d>\n"
    		  ":PROPERTIES:\n"
    		  ":CREATED:  %U\n"
    		  ":END:\n\n"
    		  "** What did I do today?\n- \n\n"
    	 ...
    	 :empty-lines 1)
    	("jw" "Journal Weekly Review"
    	 entry
    	 (file+olp "~/Documents/org/journal.org" "Journal" "Weekly Reviews")
