...
local mappings = {
  ...
  -- go right
  { 'i', '<C-f>',         '<Right>' },
  -- Ooops! This is shadowing the command to enter the command line window from
  -- command line mode...
  -- { "c", "<C-f>", "<Right>" },
  -- "overpasting"
  { 'v', 'p',             '"_dp' },
  ...
  { 'n', '<leader>/',     '<cmd>CurrentBufferFuzzyFind<cr>',                                  { desc = 'Grep word' } },
  ...
  -- ranger
  { 'n', '<leader>r',     '<cmd>FloatermNew --opener=edit --title=yazi --name=yazi yazi<CR>', { desc = 'Yazi' } },
  -- quickfix
  ...
  { 'n', '<leader>gO', '<Cmd>windo diffthis<CR>', { desc = 'diffboth (files)', } },
  ...
  { 'n', '<leader>bh',  '<cmd>Dashboard<cr>',                                            { desc = 'home', } },
  ...
  -- ui
  { 'n', '<leader>uT',  '<cmd>hi Normal guibg=NONE<cr>',                                 { desc = 'Transparency', } },
